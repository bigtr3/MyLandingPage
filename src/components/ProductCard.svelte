...
>
  <div
    class={"flex flex-col gap-8 md:gap-10 pt-8" +
  ...
  >
    ...
    after:w-1/5 after:h-1.5 after:mt-1 after:bg-slate-900"
    >
      <slot />
    </h4>
    <p>
  ...
  >
    <div
      class="rounded-t-xl h-8 sm:h-10 bg-white
  opacity-60 px-3 flex items-center gap-2"
    >
      {#each [1, 2, 3] as i}
